        ...
        <div class="box">
            ...
            <div class="top2">
                <div class="top2C">
                    ...
                    <a href="javascript:;"><div class="top2Cli top2CliYJ" onclick="remove()">公共</div></a>
                    <div class="search">
                        <div class="searchC">
    	...
    	$('#box').paging({
            ...
            callback: function(page) { // 回调函数
                ...
                if(page!=${page}){
                    ...
                    window.location.href="/wankangyuan/project/selectPublicProject?type=2&page="+page+"&strip=${rows}&searchWord="+searchWord+"&allValue="+$("#all_value").val();
                }
            }
        });
            ...
            $(".searchCt").bind("keypress" , function(event){
        		if(event.keyCode == 13){
        			var user_id=${user.id};
        			window.location.href="/wankangyuan/project/selectPublicProject?type=2&searchWord="+this.value;
